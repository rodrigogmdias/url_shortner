...
void main() {
  group('DesignText', () {
    testWidgets('defaults to h3 (18, bold)', (tester) async {
      await tester.pumpApp(const DesignText('Hello'));
    ...
    testWidgets('renders h1 style', (tester) async {
      await tester.pumpApp(const DesignText('H1', type: DesignTextType.h1));
    ...
    testWidgets('renders h2 style', (tester) async {
      await tester.pumpApp(const DesignText('H2', type: DesignTextType.h2));
    ...
    testWidgets('renders h3 style', (tester) async {
      await tester.pumpApp(const DesignText('H3', type: DesignTextType.h3));
    ...
    testWidgets('renders body style', (tester) async {
      await tester.pumpApp(const DesignText('Body', type: DesignTextType.body));
    ...
    testWidgets('renders caption style', (tester) async {
      await tester.pumpApp(
        const DesignText('Caption', type: DesignTextType.caption),
      );
